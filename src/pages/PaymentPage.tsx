  ...
  return (
    <div className="relative overflow-hidden h-screen w-full bg-gradient-to-b from-white via-[#e9eff7] to-[#CCE0F5]">
      ...
      <div className="w-full flex flex-col space-y-2 mt-[30px]">
        <p className="w-[70%] mx-auto text-[#101828] font-semibold text-[20px]">
          Payment Page
        </p>
      ...
      <img
        src={bg3}
        alt="bg2"
        className="absolute top-[120px] right-[90px] z-[1]"
      />
      <img
        src={bg4}
        alt="bg2"
        className="absolute top-[150px] right-[0px] z-[0]"
      />
      <img
        src={bg5}
        alt="bg2"
        className="absolute bottom-[-300px] left-[0px] h-[600px] z-[1]"
      />
      <img
        src={bg6}
        alt="bg2"
        className="absolute bottom-[-400px] right-[0px] h-[600px] z-[0]"
      />

      <div className="h-[60px] w-[40px] mb-4"></div>
    </div>
  );
}
