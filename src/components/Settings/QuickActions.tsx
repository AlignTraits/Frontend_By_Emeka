  ...
  return (
    <div className='border-[1px] border-[#EAECF0] shadow-md rounded-xl h-[250px] w-[100%] lg:w-[100%] p-4'>
      ...
      <div className="mt-5 flex flex-col gap-y-[10px]">
        <div onClick={() => navigate("/dashboard/settings/profile")} className="bg-[#E3E3E3] cursor-pointer h-[40px] w-[100%] rounded-xl flex gap-x-[20px] items-center px-5">
          <BsPerson className="text-[#757575]" />
          <p className="text-[#212529] font-medium text-[14px]">Update Profile Information</p>
        </div>

        <div onClick={() => navigate("/dashboard/settings/records")} className="bg-[#E3E3E3] cursor-pointer h-[40px] w-[100%] rounded-xl flex gap-x-[20px] items-center px-5">
          <RiGraduationCapFill className="text-[#757575]" />
          <p className="text-[#212529] font-medium text-[14px]">Add Academic Record</p>
        </div>

        <div onClick={() => navigate("/dashboard/settings/security")} className="bg-[#E3E3E3] cursor-pointer h-[40px] w-[100%] rounded-xl flex gap-x-[20px] items-center px-5">
