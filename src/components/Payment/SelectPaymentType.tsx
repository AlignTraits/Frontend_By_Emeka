  ...
  return (
      ...
      <div className="flex gap-x-[20px] justify-center items-center mt-10 p-4">
        <button onClick={() => setPaymentType("card")} 
          className={`${paymentType === "card" ? "bg-[#EAF2FB]" : ""} transition-all duration-300 cursor-pointer flex justify-center gap-x-[5px] h-[60px] w-[250px] rounded-[20px] border-[1px] border-[#004085] shadow-lg items-center`}
        >
        ...
        <button onClick={() => setPaymentType("transfer")} 
          className={`${paymentType === "transfer" ? "bg-[#EAF2FB]" : ""} transition-all duration-300 cursor-pointer flex justify-center gap-x-[5px] h-[60px] w-[200px] rounded-[20px] border-[1px] border-[#004085] shadow-lg items-center`}
        >
