...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    ...
    >
      <div className="absolute top-[-18px] right-[0px] text-[#000] font-medium text-xs sm:text-sm text-center mb-2">
        {type}
      </div>
      ...
      <div
        className={classNames("text-center mb-4 font-medium mt-6 sm:mt-10", {
      ...
      {/* Divider */}
      <div
        className={`w-full h-px mb-6 ${isActive ? "bg-blue-400" : "bg-gray-200"}`}
      />
